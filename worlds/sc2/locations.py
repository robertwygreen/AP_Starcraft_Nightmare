...
class Sc2Location(enum.IntEnum):
    ...
    LIBERATION_DAY_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 100, "Victory", SC2Mission.LIBERATION_DAY, LocationType.VICTORY
    LIBERATION_DAY_N_FIRST_STATUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 101, "First Statue", SC2Mission.LIBERATION_DAY, LocationType.VANILLA
    LIBERATION_DAY_N_SECOND_STATUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 102, "Second Statue", SC2Mission.LIBERATION_DAY, LocationType.VANILLA
    LIBERATION_DAY_N_THIRD_STATUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 103, "Third Statue", SC2Mission.LIBERATION_DAY, LocationType.VANILLA
    LIBERATION_DAY_N_FOURTH_STATUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 104, "Fourth Statue", SC2Mission.LIBERATION_DAY, LocationType.VANILLA
    LIBERATION_DAY_N_FIFTH_STATUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 105, "Fifth Statue", SC2Mission.LIBERATION_DAY, LocationType.VANILLA
    LIBERATION_DAY_N_SIXTH_STATUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 106, "Sixth Statue", SC2Mission.LIBERATION_DAY, LocationType.VANILLA
    LIBERATION_DAY_N_SPECIAL_DELIVERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 107, "Special Delivery", SC2Mission.LIBERATION_DAY, LocationType.EXTRA
    LIBERATION_DAY_N_TRANSPORT = SC2_NIGHTMARE_LOC_ID_OFFSET + 108, "Transport", SC2Mission.LIBERATION_DAY, LocationType.EXTRA

    THE_OUTLAWS_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 200, "Victory", SC2Mission.THE_OUTLAWS, LocationType.VICTORY
    THE_OUTLAWS_N_REBEL_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 201, "Rebel Base", SC2Mission.THE_OUTLAWS, LocationType.VANILLA
    THE_OUTLAWS_N_NORTH_RESOURCE_PICKUPS = SC2_NIGHTMARE_LOC_ID_OFFSET + 202, "North Resource Pickups", SC2Mission.THE_OUTLAWS, LocationType.EXTRA
    THE_OUTLAWS_N_BUNKER = SC2_NIGHTMARE_LOC_ID_OFFSET + 203, "Bunker", SC2Mission.THE_OUTLAWS, LocationType.VANILLA
    THE_OUTLAWS_N_CLOSE_RESOURCE_PICKUPS = SC2_NIGHTMARE_LOC_ID_OFFSET + 204, "Close Resource Pickups", SC2Mission.THE_OUTLAWS, LocationType.EXTRA
    THE_OUTLAWS_N_WIN_IN_UNDER_10_MINUTES = SC2_NIGHTMARE_LOC_ID_OFFSET + 205, "Win In Under 10 Minutes", SC2Mission.THE_OUTLAWS, LocationType.CHALLENGE, LocationFlag.SPEEDRUN

    ZERO_HOUR_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 300, "Victory", SC2Mission.ZERO_HOUR, LocationType.VICTORY
    ZERO_HOUR_N_FIRST_GROUP_RESCUED = SC2_NIGHTMARE_LOC_ID_OFFSET + 301, "First Group Rescued", SC2Mission.ZERO_HOUR, LocationType.VANILLA
    ZERO_HOUR_N_SECOND_GROUP_RESCUED = SC2_NIGHTMARE_LOC_ID_OFFSET + 302, "Second Group Rescued", SC2Mission.ZERO_HOUR, LocationType.VANILLA
    ZERO_HOUR_N_THIRD_GROUP_RESCUED = SC2_NIGHTMARE_LOC_ID_OFFSET + 303, "Third Group Rescued", SC2Mission.ZERO_HOUR, LocationType.VANILLA
    ZERO_HOUR_N_FIRST_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 304, "First Hatchery", SC2Mission.ZERO_HOUR, LocationType.CHALLENGE, LocationFlag.BASEBUST
    ZERO_HOUR_N_SECOND_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 305, "Second Hatchery", SC2Mission.ZERO_HOUR, LocationType.CHALLENGE, LocationFlag.BASEBUST
    ZERO_HOUR_N_THIRD_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 306, "Third Hatchery", SC2Mission.ZERO_HOUR, LocationType.CHALLENGE, LocationFlag.BASEBUST
    ZERO_HOUR_N_FOURTH_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 307, "Fourth Hatchery", SC2Mission.ZERO_HOUR, LocationType.CHALLENGE, LocationFlag.BASEBUST
    ZERO_HOUR_N_RIDES_ON_ITS_WAY = SC2_NIGHTMARE_LOC_ID_OFFSET + 308, "Ride's on its Way", SC2Mission.ZERO_HOUR, LocationType.EXTRA
    ZERO_HOUR_N_HOLD_JUST_A_LITTLE_LONGER = SC2_NIGHTMARE_LOC_ID_OFFSET + 309, "Hold Just a Little Longer", SC2Mission.ZERO_HOUR, LocationType.EXTRA
    ZERO_HOUR_N_CAVALRYS_ON_THE_WAY = SC2_NIGHTMARE_LOC_ID_OFFSET + 310, "Cavalry's on the Way", SC2Mission.ZERO_HOUR, LocationType.EXTRA

    EVACUATION_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 400, "Victory", SC2Mission.EVACUATION, LocationType.VICTORY
    EVACUATION_N_NORTH_CHRYSALIS = SC2_NIGHTMARE_LOC_ID_OFFSET + 401, "North Chrysalis", SC2Mission.EVACUATION, LocationType.VANILLA
    EVACUATION_N_WEST_CHRYSALIS = SC2_NIGHTMARE_LOC_ID_OFFSET + 402, "West Chrysalis", SC2Mission.EVACUATION, LocationType.VANILLA
    EVACUATION_N_EAST_CHRYSALIS = SC2_NIGHTMARE_LOC_ID_OFFSET + 403, "East Chrysalis", SC2Mission.EVACUATION, LocationType.VANILLA
    EVACUATION_N_REACH_HANSON = SC2_NIGHTMARE_LOC_ID_OFFSET + 404, "Reach Hanson", SC2Mission.EVACUATION, LocationType.EXTRA
    EVACUATION_N_SECRET_RESOURCE_STASH = SC2_NIGHTMARE_LOC_ID_OFFSET + 405, "Secret Resource Stash", SC2Mission.EVACUATION, LocationType.EXTRA
    EVACUATION_N_FLAWLESS = SC2_NIGHTMARE_LOC_ID_OFFSET + 406, "Flawless", SC2Mission.EVACUATION, LocationType.CHALLENGE, LocationFlag.PREVENTATIVE
    EVACUATION_N_WESTERN_ZERG_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 407, "Western Zerg Base", SC2Mission.EVACUATION, LocationType.MASTERY, LocationFlag.BASEBUST
    EVACUATION_N_EASTERN_ZERG_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 408, "Eastern Zerg Base", SC2Mission.EVACUATION, LocationType.MASTERY, LocationFlag.BASEBUST

    OUTBREAK_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 500, "Victory", SC2Mission.OUTBREAK, LocationType.VICTORY
    OUTBREAK_N_LEFT_INFESTOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 501, "Left Infestor", SC2Mission.OUTBREAK, LocationType.VANILLA
    OUTBREAK_N_RIGHT_INFESTOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 502, "Right Infestor", SC2Mission.OUTBREAK, LocationType.VANILLA
    OUTBREAK_N_NORTH_INFESTED_COMMAND_CENTER = SC2_NIGHTMARE_LOC_ID_OFFSET + 503, "North Infested Command Center", SC2Mission.OUTBREAK, LocationType.EXTRA
    OUTBREAK_N_SOUTH_INFESTED_COMMAND_CENTER = SC2_NIGHTMARE_LOC_ID_OFFSET + 504, "South Infested Command Center", SC2Mission.OUTBREAK, LocationType.EXTRA
    OUTBREAK_N_NORTHWEST_BAR = SC2_NIGHTMARE_LOC_ID_OFFSET + 505, "Northwest Bar", SC2Mission.OUTBREAK, LocationType.EXTRA
    OUTBREAK_N_NORTH_BAR = SC2_NIGHTMARE_LOC_ID_OFFSET + 506, "North Bar", SC2Mission.OUTBREAK, LocationType.EXTRA
    OUTBREAK_N_SOUTH_BAR = SC2_NIGHTMARE_LOC_ID_OFFSET + 507, "South Bar", SC2Mission.OUTBREAK, LocationType.EXTRA

    SAFE_HAVEN_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 600, "Victory", SC2Mission.SAFE_HAVEN, LocationType.VICTORY
    SAFE_HAVEN_N_NORTH_NEXUS = SC2_NIGHTMARE_LOC_ID_OFFSET + 601, "North Nexus", SC2Mission.SAFE_HAVEN, LocationType.EXTRA
    SAFE_HAVEN_N_EAST_NEXUS = SC2_NIGHTMARE_LOC_ID_OFFSET + 602, "East Nexus", SC2Mission.SAFE_HAVEN, LocationType.EXTRA
    SAFE_HAVEN_N_SOUTH_NEXUS = SC2_NIGHTMARE_LOC_ID_OFFSET + 603, "South Nexus", SC2Mission.SAFE_HAVEN, LocationType.EXTRA
    SAFE_HAVEN_N_FIRST_TERROR_FLEET = SC2_NIGHTMARE_LOC_ID_OFFSET + 604, "First Terror Fleet", SC2Mission.SAFE_HAVEN, LocationType.VANILLA
    SAFE_HAVEN_N_SECOND_TERROR_FLEET = SC2_NIGHTMARE_LOC_ID_OFFSET + 605, "Second Terror Fleet", SC2Mission.SAFE_HAVEN, LocationType.VANILLA
    SAFE_HAVEN_N_THIRD_TERROR_FLEET = SC2_NIGHTMARE_LOC_ID_OFFSET + 606, "Third Terror Fleet", SC2Mission.SAFE_HAVEN, LocationType.VANILLA

    HAVENS_FALL_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 700, "Victory", SC2Mission.HAVENS_FALL, LocationType.VICTORY
    HAVENS_FALL_N_NORTH_HIVE = SC2_NIGHTMARE_LOC_ID_OFFSET + 701, "North Hive", SC2Mission.HAVENS_FALL, LocationType.VANILLA
    HAVENS_FALL_N_EAST_HIVE = SC2_NIGHTMARE_LOC_ID_OFFSET + 702, "East Hive", SC2Mission.HAVENS_FALL, LocationType.VANILLA
    HAVENS_FALL_N_SOUTH_HIVE = SC2_NIGHTMARE_LOC_ID_OFFSET + 703, "South Hive", SC2Mission.HAVENS_FALL, LocationType.VANILLA
    HAVENS_FALL_N_NORTHEAST_COLONY_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 704, "Northeast Colony Base", SC2Mission.HAVENS_FALL, LocationType.CHALLENGE
    HAVENS_FALL_N_EAST_COLONY_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 705, "East Colony Base", SC2Mission.HAVENS_FALL, LocationType.CHALLENGE
    HAVENS_FALL_N_MIDDLE_COLONY_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 706, "Middle Colony Base", SC2Mission.HAVENS_FALL, LocationType.CHALLENGE
    HAVENS_FALL_N_SOUTHEAST_COLONY_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 707, "Southeast Colony Base", SC2Mission.HAVENS_FALL, LocationType.CHALLENGE
    HAVENS_FALL_N_SOUTHWEST_COLONY_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 708, "Southwest Colony Base", SC2Mission.HAVENS_FALL, LocationType.CHALLENGE
    HAVENS_FALL_N_SOUTHWEST_GAS_PICKUPS = SC2_NIGHTMARE_LOC_ID_OFFSET + 709, "Southwest Gas Pickups", SC2Mission.HAVENS_FALL, LocationType.EXTRA
    HAVENS_FALL_N_EAST_GAS_PICKUPS = SC2_NIGHTMARE_LOC_ID_OFFSET + 710, "East Gas Pickups", SC2Mission.HAVENS_FALL, LocationType.EXTRA
    HAVENS_FALL_N_SOUTHEAST_GAS_PICKUPS = SC2_NIGHTMARE_LOC_ID_OFFSET + 711, "Southeast Gas Pickups", SC2Mission.HAVENS_FALL, LocationType.EXTRA

    SMASH_AND_GRAB_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 800, "Victory", SC2Mission.SMASH_AND_GRAB, LocationType.VICTORY
    SMASH_AND_GRAB_N_FIRST_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 801, "First Relic", SC2Mission.SMASH_AND_GRAB, LocationType.VANILLA
    SMASH_AND_GRAB_N_SECOND_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 802, "Second Relic", SC2Mission.SMASH_AND_GRAB, LocationType.VANILLA
    SMASH_AND_GRAB_N_THIRD_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 803, "Third Relic", SC2Mission.SMASH_AND_GRAB, LocationType.VANILLA
    SMASH_AND_GRAB_N_FOURTH_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 804, "Fourth Relic", SC2Mission.SMASH_AND_GRAB, LocationType.VANILLA
    SMASH_AND_GRAB_N_FIRST_FORCEFIELD_AREA_BUSTED = SC2_NIGHTMARE_LOC_ID_OFFSET + 805, "First Forcefield Area Busted", SC2Mission.SMASH_AND_GRAB, LocationType.EXTRA
    SMASH_AND_GRAB_N_SECOND_FORCEFIELD_AREA_BUSTED = SC2_NIGHTMARE_LOC_ID_OFFSET + 806, "Second Forcefield Area Busted", SC2Mission.SMASH_AND_GRAB, LocationType.EXTRA
    SMASH_AND_GRAB_N_DEFEAT_KERRIGAN = SC2_NIGHTMARE_LOC_ID_OFFSET + 807, "Defeat Kerrigan", SC2Mission.SMASH_AND_GRAB, LocationType.MASTERY, LocationFlag.BASEBUST

    THE_DIG_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 900, "Victory", SC2Mission.THE_DIG, LocationType.VICTORY
    THE_DIG_N_LEFT_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 901, "Left Relic", SC2Mission.THE_DIG, LocationType.VANILLA
    THE_DIG_N_RIGHT_GROUND_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 902, "Right Ground Relic", SC2Mission.THE_DIG, LocationType.VANILLA
    THE_DIG_N_RIGHT_CLIFF_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 903, "Right Cliff Relic", SC2Mission.THE_DIG, LocationType.VANILLA
    THE_DIG_N_MOEBIUS_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 904, "Moebius Base", SC2Mission.THE_DIG, LocationType.EXTRA
    THE_DIG_N_DOOR_OUTER_LAYER = SC2_NIGHTMARE_LOC_ID_OFFSET + 905, "Door Outer Layer", SC2Mission.THE_DIG, LocationType.EXTRA
    THE_DIG_N_DOOR_THERMAL_BARRIER = SC2_NIGHTMARE_LOC_ID_OFFSET + 906, "Door Thermal Barrier", SC2Mission.THE_DIG, LocationType.EXTRA
    THE_DIG_N_CUTTING_THROUGH_THE_CORE = SC2_NIGHTMARE_LOC_ID_OFFSET + 907, "Cutting Through the Core", SC2Mission.THE_DIG, LocationType.EXTRA
    THE_DIG_N_STRUCTURE_ACCESS_IMMINENT = SC2_NIGHTMARE_LOC_ID_OFFSET + 908, "Structure Access Imminent", SC2Mission.THE_DIG, LocationType.EXTRA
    THE_DIG_N_NORTHWESTERN_PROTOSS_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 909, "Northwestern Protoss Base", SC2Mission.THE_DIG, LocationType.MASTERY, LocationFlag.BASEBUST
    THE_DIG_N_NORTHEASTERN_PROTOSS_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 910, "Northeastern Protoss Base", SC2Mission.THE_DIG, LocationType.MASTERY, LocationFlag.BASEBUST
    THE_DIG_N_EASTERN_PROTOSS_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 911, "Eastern Protoss Base", SC2Mission.THE_DIG, LocationType.MASTERY, LocationFlag.BASEBUST

    THE_MOEBIUS_FACTOR_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1000, "Victory", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.VICTORY
    THE_MOEBIUS_FACTOR_N_1ST_DATA_CORE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1001, "1st Data Core", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.VANILLA
    THE_MOEBIUS_FACTOR_N_2ND_DATA_CORE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1002, "2nd Data Core", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.VANILLA
    THE_MOEBIUS_FACTOR_N_SOUTH_RESCUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1003, "South Rescue", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.EXTRA
    THE_MOEBIUS_FACTOR_N_WALL_RESCUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1004, "Wall Rescue", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.EXTRA
    THE_MOEBIUS_FACTOR_N_MID_RESCUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1005, "Mid Rescue", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.EXTRA
    THE_MOEBIUS_FACTOR_N_NYDUS_ROOF_RESCUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1006, "Nydus Roof Rescue", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.EXTRA
    THE_MOEBIUS_FACTOR_N_ALIVE_INSIDE_RESCUE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1007, "Alive Inside Rescue", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.EXTRA
    THE_MOEBIUS_FACTOR_N_BRUTALISK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1008, "Brutalisk", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.VANILLA
    THE_MOEBIUS_FACTOR_N_3RD_DATA_CORE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1009, "3rd Data Core", SC2Mission.THE_MOEBIUS_FACTOR, LocationType.VANILLA

    SUPERNOVA_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1100, "Victory", SC2Mission.SUPERNOVA, LocationType.VICTORY
    SUPERNOVA_N_WEST_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1101, "West Relic", SC2Mission.SUPERNOVA, LocationType.VANILLA
    SUPERNOVA_N_NORTH_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1102, "North Relic", SC2Mission.SUPERNOVA, LocationType.VANILLA
    SUPERNOVA_N_SOUTH_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1103, "South Relic", SC2Mission.SUPERNOVA, LocationType.VANILLA
    SUPERNOVA_N_EAST_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1104, "East Relic", SC2Mission.SUPERNOVA, LocationType.VANILLA
    SUPERNOVA_N_LANDING_ZONE_CLEARED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1105, "Landing Zone Cleared", SC2Mission.SUPERNOVA, LocationType.EXTRA
    SUPERNOVA_N_MIDDLE_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1106, "Middle Base", SC2Mission.SUPERNOVA, LocationType.EXTRA
    SUPERNOVA_N_SOUTHEAST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1107, "Southeast Base", SC2Mission.SUPERNOVA, LocationType.EXTRA

    MAW_OF_THE_VOID_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1200, "Victory", SC2Mission.MAW_OF_THE_VOID, LocationType.VICTORY
    MAW_OF_THE_VOID_N_LANDING_ZONE_CLEARED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1201, "Landing Zone Cleared", SC2Mission.MAW_OF_THE_VOID, LocationType.EXTRA
    MAW_OF_THE_VOID_N_EXPANSION_PRISONERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1202, "Expansion Prisoners", SC2Mission.MAW_OF_THE_VOID, LocationType.VANILLA
    MAW_OF_THE_VOID_N_SOUTH_CLOSE_PRISONERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1203, "South Close Prisoners", SC2Mission.MAW_OF_THE_VOID, LocationType.VANILLA
    MAW_OF_THE_VOID_N_SOUTH_FAR_PRISONERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1204, "South Far Prisoners", SC2Mission.MAW_OF_THE_VOID, LocationType.VANILLA
    MAW_OF_THE_VOID_N_NORTH_PRISONERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1205, "North Prisoners", SC2Mission.MAW_OF_THE_VOID, LocationType.VANILLA
    MAW_OF_THE_VOID_N_MOTHERSHIP = SC2_NIGHTMARE_LOC_ID_OFFSET + 1206, "Mothership", SC2Mission.MAW_OF_THE_VOID, LocationType.EXTRA
    MAW_OF_THE_VOID_N_EXPANSION_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1207, "Expansion Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.EXTRA
    MAW_OF_THE_VOID_N_MIDDLE_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1208, "Middle Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.EXTRA
    MAW_OF_THE_VOID_N_SOUTHEAST_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1209, "Southeast Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.EXTRA
    MAW_OF_THE_VOID_N_STARGATE_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1210, "Stargate Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.EXTRA
    MAW_OF_THE_VOID_N_NORTHWEST_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1211, "Northwest Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.CHALLENGE
    MAW_OF_THE_VOID_N_WEST_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1212, "West Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.CHALLENGE
    MAW_OF_THE_VOID_N_SOUTHWEST_RIP_FIELD_GENERATOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 1213, "Southwest Rip Field Generator", SC2Mission.MAW_OF_THE_VOID, LocationType.CHALLENGE

    DEVILS_PLAYGROUND_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1300, "Victory", SC2Mission.DEVILS_PLAYGROUND, LocationType.VICTORY
    DEVILS_PLAYGROUND_N_TOSHS_MINERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1301, "Tosh's Miners", SC2Mission.DEVILS_PLAYGROUND, LocationType.VANILLA
    DEVILS_PLAYGROUND_N_BRUTALISK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1302, "Brutalisk", SC2Mission.DEVILS_PLAYGROUND, LocationType.VANILLA
    DEVILS_PLAYGROUND_N_NORTH_REAPERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1303, "North Reapers", SC2Mission.DEVILS_PLAYGROUND, LocationType.EXTRA
    DEVILS_PLAYGROUND_N_MIDDLE_REAPERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1304, "Middle Reapers", SC2Mission.DEVILS_PLAYGROUND, LocationType.EXTRA
    DEVILS_PLAYGROUND_N_SOUTHWEST_REAPERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1305, "Southwest Reapers", SC2Mission.DEVILS_PLAYGROUND, LocationType.EXTRA
    DEVILS_PLAYGROUND_N_SOUTHEAST_REAPERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1306, "Southeast Reapers", SC2Mission.DEVILS_PLAYGROUND, LocationType.EXTRA
    DEVILS_PLAYGROUND_N_EAST_REAPERS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1307, "East Reapers", SC2Mission.DEVILS_PLAYGROUND, LocationType.EXTRA
    DEVILS_PLAYGROUND_N_ZERG_CLEARED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1308, "Zerg Cleared", SC2Mission.DEVILS_PLAYGROUND, LocationType.CHALLENGE, LocationFlag.BASEBUST

    WELCOME_TO_THE_JUNGLE_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1400, "Victory", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.VICTORY
    WELCOME_TO_THE_JUNGLE_N_CLOSE_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1401, "Close Relic", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.VANILLA
    WELCOME_TO_THE_JUNGLE_N_WEST_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1402, "West Relic", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.VANILLA
    WELCOME_TO_THE_JUNGLE_N_NORTH_EAST_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1403, "North-East Relic", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.VANILLA
    WELCOME_TO_THE_JUNGLE_N_MIDDLE_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1404, "Middle Base", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.EXTRA
    WELCOME_TO_THE_JUNGLE_N_PROTOSS_CLEARED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1405, "Protoss Cleared", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.MASTERY, LocationFlag.BASEBUST
    WELCOME_TO_THE_JUNGLE_N_NO_TERRAZINE_NODES_SEALED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1406, "No Terrazine Nodes Sealed", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.CHALLENGE, LocationFlag.PREVENTATIVE
    WELCOME_TO_THE_JUNGLE_N_UP_TO_1_TERRAZINE_NODE_SEALED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1407, "Up to 1 Terrazine Node Sealed", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.CHALLENGE, LocationFlag.PREVENTATIVE
    WELCOME_TO_THE_JUNGLE_N_UP_TO_2_TERRAZINE_NODES_SEALED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1408, "Up to 2 Terrazine Nodes Sealed", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.CHALLENGE, LocationFlag.PREVENTATIVE
    WELCOME_TO_THE_JUNGLE_N_UP_TO_3_TERRAZINE_NODES_SEALED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1409, "Up to 3 Terrazine Nodes Sealed", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.CHALLENGE, LocationFlag.PREVENTATIVE
    WELCOME_TO_THE_JUNGLE_N_UP_TO_4_TERRAZINE_NODES_SEALED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1410, "Up to 4 Terrazine Nodes Sealed", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.EXTRA, LocationFlag.PREVENTATIVE
    WELCOME_TO_THE_JUNGLE_N_UP_TO_5_TERRAZINE_NODES_SEALED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1411, "Up to 5 Terrazine Nodes Sealed", SC2Mission.WELCOME_TO_THE_JUNGLE, LocationType.EXTRA, LocationFlag.PREVENTATIVE

    BREAKOUT_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1500, "Victory", SC2Mission.BREAKOUT, LocationType.VICTORY
    BREAKOUT_N_DIAMONDBACK_PRISON = SC2_NIGHTMARE_LOC_ID_OFFSET + 1501, "Diamondback Prison", SC2Mission.BREAKOUT, LocationType.VANILLA
    BREAKOUT_N_SIEGE_TANK_PRISON = SC2_NIGHTMARE_LOC_ID_OFFSET + 1502, "Siege Tank Prison", SC2Mission.BREAKOUT, LocationType.VANILLA
    BREAKOUT_N_FIRST_CHECKPOINT = SC2_NIGHTMARE_LOC_ID_OFFSET + 1503, "First Checkpoint", SC2Mission.BREAKOUT, LocationType.EXTRA
    BREAKOUT_N_SECOND_CHECKPOINT = SC2_NIGHTMARE_LOC_ID_OFFSET + 1504, "Second Checkpoint", SC2Mission.BREAKOUT, LocationType.EXTRA

    GHOST_OF_A_CHANCE_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1600, "Victory", SC2Mission.GHOST_OF_A_CHANCE, LocationType.VICTORY
    GHOST_OF_A_CHANCE_N_TERRAZINE_TANK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1601, "Terrazine Tank", SC2Mission.GHOST_OF_A_CHANCE, LocationType.EXTRA
    GHOST_OF_A_CHANCE_N_JORIUM_STOCKPILE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1602, "Jorium Stockpile", SC2Mission.GHOST_OF_A_CHANCE, LocationType.EXTRA
    GHOST_OF_A_CHANCE_N_FIRST_ISLAND_SPECTRES = SC2_NIGHTMARE_LOC_ID_OFFSET + 1603, "First Island Spectres", SC2Mission.GHOST_OF_A_CHANCE, LocationType.VANILLA
    GHOST_OF_A_CHANCE_N_SECOND_ISLAND_SPECTRES = SC2_NIGHTMARE_LOC_ID_OFFSET + 1604, "Second Island Spectres", SC2Mission.GHOST_OF_A_CHANCE, LocationType.VANILLA
    GHOST_OF_A_CHANCE_N_THIRD_ISLAND_SPECTRES = SC2_NIGHTMARE_LOC_ID_OFFSET + 1605, "Third Island Spectres", SC2Mission.GHOST_OF_A_CHANCE, LocationType.VANILLA

    THE_GREAT_TRAIN_ROBBERY_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1700, "Victory", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.VICTORY
    THE_GREAT_TRAIN_ROBBERY_N_NORTH_DEFILER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1701, "North Defiler", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.VANILLA
    THE_GREAT_TRAIN_ROBBERY_N_MID_DEFILER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1702, "Mid Defiler", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.VANILLA
    THE_GREAT_TRAIN_ROBBERY_N_SOUTH_DEFILER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1703, "South Defiler", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.VANILLA
    THE_GREAT_TRAIN_ROBBERY_N_CLOSE_DIAMONDBACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1704, "Close Diamondback", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_NORTHWEST_DIAMONDBACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1705, "Northwest Diamondback", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_NORTH_DIAMONDBACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1706, "North Diamondback", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_NORTHEAST_DIAMONDBACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1707, "Northeast Diamondback", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_SOUTHWEST_DIAMONDBACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1708, "Southwest Diamondback", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_SOUTHEAST_DIAMONDBACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 1709, "Southeast Diamondback", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_KILL_TEAM = SC2_NIGHTMARE_LOC_ID_OFFSET + 1710, "Kill Team", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.CHALLENGE
    THE_GREAT_TRAIN_ROBBERY_N_FLAWLESS = SC2_NIGHTMARE_LOC_ID_OFFSET + 1711, "Flawless", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.CHALLENGE, LocationFlag.PREVENTATIVE
    THE_GREAT_TRAIN_ROBBERY_N_2_TRAINS_DESTROYED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1712, "2 Trains Destroyed", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_4_TRAINS_DESTROYED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1713, "4 Trains Destroyed", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA
    THE_GREAT_TRAIN_ROBBERY_N_6_TRAINS_DESTROYED = SC2_NIGHTMARE_LOC_ID_OFFSET + 1714, "6 Trains Destroyed", SC2Mission.THE_GREAT_TRAIN_ROBBERY, LocationType.EXTRA

    CUTTHROAT_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1800, "Victory", SC2Mission.CUTTHROAT, LocationType.VICTORY
    CUTTHROAT_N_MIRA_HAN = SC2_NIGHTMARE_LOC_ID_OFFSET + 1801, "Mira Han", SC2Mission.CUTTHROAT, LocationType.EXTRA
    CUTTHROAT_N_NORTH_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1802, "North Relic", SC2Mission.CUTTHROAT, LocationType.VANILLA
    CUTTHROAT_N_MID_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1803, "Mid Relic", SC2Mission.CUTTHROAT, LocationType.VANILLA
    CUTTHROAT_N_SOUTHWEST_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 1804, "Southwest Relic", SC2Mission.CUTTHROAT, LocationType.VANILLA
    CUTTHROAT_N_NORTH_COMMAND_CENTER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1805, "North Command Center", SC2Mission.CUTTHROAT, LocationType.EXTRA
    CUTTHROAT_N_SOUTH_COMMAND_CENTER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1806, "South Command Center", SC2Mission.CUTTHROAT, LocationType.EXTRA
    CUTTHROAT_N_WEST_COMMAND_CENTER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1807, "West Command Center", SC2Mission.CUTTHROAT, LocationType.EXTRA

    ENGINE_OF_DESTRUCTION_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 1900, "Victory", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.VICTORY
    ENGINE_OF_DESTRUCTION_N_ODIN = SC2_NIGHTMARE_LOC_ID_OFFSET + 1901, "Odin", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.EXTRA
    ENGINE_OF_DESTRUCTION_N_LOKI = SC2_NIGHTMARE_LOC_ID_OFFSET + 1902, "Loki", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.CHALLENGE
    ENGINE_OF_DESTRUCTION_N_LAB_DEVOURER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1903, "Lab Devourer", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.VANILLA
    ENGINE_OF_DESTRUCTION_N_NORTH_DEVOURER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1904, "North Devourer", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.VANILLA
    ENGINE_OF_DESTRUCTION_N_SOUTHEAST_DEVOURER = SC2_NIGHTMARE_LOC_ID_OFFSET + 1905, "Southeast Devourer", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.VANILLA
    ENGINE_OF_DESTRUCTION_N_WEST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1906, "West Base", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.EXTRA
    ENGINE_OF_DESTRUCTION_N_NORTHWEST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1907, "Northwest Base", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.EXTRA
    ENGINE_OF_DESTRUCTION_N_NORTHEAST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1908, "Northeast Base", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.EXTRA
    ENGINE_OF_DESTRUCTION_N_SOUTHEAST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 1909, "Southeast Base", SC2Mission.ENGINE_OF_DESTRUCTION, LocationType.EXTRA

    MEDIA_BLITZ_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2000, "Victory", SC2Mission.MEDIA_BLITZ, LocationType.VICTORY
    MEDIA_BLITZ_N_TOWER_1 = SC2_NIGHTMARE_LOC_ID_OFFSET + 2001, "Tower 1", SC2Mission.MEDIA_BLITZ, LocationType.VANILLA
    MEDIA_BLITZ_N_TOWER_2 = SC2_NIGHTMARE_LOC_ID_OFFSET + 2002, "Tower 2", SC2Mission.MEDIA_BLITZ, LocationType.VANILLA
    MEDIA_BLITZ_N_TOWER_3 = SC2_NIGHTMARE_LOC_ID_OFFSET + 2003, "Tower 3", SC2Mission.MEDIA_BLITZ, LocationType.VANILLA
    MEDIA_BLITZ_N_SCIENCE_FACILITY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2004, "Science Facility", SC2Mission.MEDIA_BLITZ, LocationType.VANILLA
    MEDIA_BLITZ_N_ALL_BARRACKS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2005, "All Barracks", SC2Mission.MEDIA_BLITZ, LocationType.EXTRA
    MEDIA_BLITZ_N_ALL_FACTORIES = SC2_NIGHTMARE_LOC_ID_OFFSET + 2006, "All Factories", SC2Mission.MEDIA_BLITZ, LocationType.EXTRA
    MEDIA_BLITZ_N_ALL_STARPORTS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2007, "All Starports", SC2Mission.MEDIA_BLITZ, LocationType.EXTRA
    MEDIA_BLITZ_N_ODIN_NOT_TRASHED = SC2_NIGHTMARE_LOC_ID_OFFSET + 2008, "Odin Not Trashed", SC2Mission.MEDIA_BLITZ, LocationType.CHALLENGE
    MEDIA_BLITZ_N_SURPRISE_ATTACK_ENDS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2009, "Surprise Attack Ends", SC2Mission.MEDIA_BLITZ, LocationType.EXTRA

    PIERCING_OF_THE_SHROUD_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2100, "Victory", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.VICTORY
    PIERCING_OF_THE_SHROUD_N_HOLDING_CELL_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 2101, "Holding Cell Relic", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.VANILLA
    PIERCING_OF_THE_SHROUD_N_BRUTALISK_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 2102, "Brutalisk Relic", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.VANILLA
    PIERCING_OF_THE_SHROUD_N_FIRST_ESCAPE_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 2103, "First Escape Relic", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.VANILLA
    PIERCING_OF_THE_SHROUD_N_SECOND_ESCAPE_RELIC = SC2_NIGHTMARE_LOC_ID_OFFSET + 2104, "Second Escape Relic", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.VANILLA
    PIERCING_OF_THE_SHROUD_N_BRUTALISK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2105, "Brutalisk", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.VANILLA
    PIERCING_OF_THE_SHROUD_N_FUSION_REACTOR = SC2_NIGHTMARE_LOC_ID_OFFSET + 2106, "Fusion Reactor", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.EXTRA
    PIERCING_OF_THE_SHROUD_N_ENTRANCE_HOLDING_PEN = SC2_NIGHTMARE_LOC_ID_OFFSET + 2107, "Entrance Holding Pen", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.EXTRA
    PIERCING_OF_THE_SHROUD_N_CARGO_BAY_WARBOT = SC2_NIGHTMARE_LOC_ID_OFFSET + 2108, "Cargo Bay Warbot", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.EXTRA
    PIERCING_OF_THE_SHROUD_N_ESCAPE_WARBOT = SC2_NIGHTMARE_LOC_ID_OFFSET + 2109, "Escape Warbot", SC2Mission.PIERCING_OF_THE_SHROUD, LocationType.EXTRA

    WHISPERS_OF_DOOM_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2200, "Victory", SC2Mission.WHISPERS_OF_DOOM, LocationType.VICTORY
    WHISPERS_OF_DOOM_N_FIRST_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2201, "First Hatchery", SC2Mission.WHISPERS_OF_DOOM, LocationType.VANILLA
    WHISPERS_OF_DOOM_N_SECOND_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2202, "Second Hatchery", SC2Mission.WHISPERS_OF_DOOM, LocationType.VANILLA
    WHISPERS_OF_DOOM_N_THIRD_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2203, "Third Hatchery", SC2Mission.WHISPERS_OF_DOOM, LocationType.VANILLA
    WHISPERS_OF_DOOM_N_FIRST_PROPHECY_FRAGMENT = SC2_NIGHTMARE_LOC_ID_OFFSET + 2204, "First Prophecy Fragment", SC2Mission.WHISPERS_OF_DOOM, LocationType.EXTRA
    WHISPERS_OF_DOOM_N_SECOND_PROPHECY_FRAGMENT = SC2_NIGHTMARE_LOC_ID_OFFSET + 2205, "Second Prophecy Fragment", SC2Mission.WHISPERS_OF_DOOM, LocationType.EXTRA
    WHISPERS_OF_DOOM_N_THIRD_PROPHECY_FRAGMENT = SC2_NIGHTMARE_LOC_ID_OFFSET + 2206, "Third Prophecy Fragment", SC2Mission.WHISPERS_OF_DOOM, LocationType.EXTRA

    A_SINISTER_TURN_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2300, "Victory", SC2Mission.A_SINISTER_TURN, LocationType.VICTORY
    A_SINISTER_TURN_N_ROBOTICS_FACILITY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2301, "Robotics Facility", SC2Mission.A_SINISTER_TURN, LocationType.VANILLA
    A_SINISTER_TURN_N_DARK_SHRINE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2302, "Dark Shrine", SC2Mission.A_SINISTER_TURN, LocationType.VANILLA
    A_SINISTER_TURN_N_TEMPLAR_ARCHIVES = SC2_NIGHTMARE_LOC_ID_OFFSET + 2303, "Templar Archives", SC2Mission.A_SINISTER_TURN, LocationType.VANILLA
    A_SINISTER_TURN_N_NORTHEAST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2304, "Northeast Base", SC2Mission.A_SINISTER_TURN, LocationType.EXTRA
    A_SINISTER_TURN_N_SOUTHWEST_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2305, "Southwest Base", SC2Mission.A_SINISTER_TURN, LocationType.CHALLENGE, LocationFlag.BASEBUST
    A_SINISTER_TURN_N_MAAR = SC2_NIGHTMARE_LOC_ID_OFFSET + 2306, "Maar", SC2Mission.A_SINISTER_TURN, LocationType.EXTRA
    A_SINISTER_TURN_N_NORTHWEST_PRESERVER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2307, "Northwest Preserver", SC2Mission.A_SINISTER_TURN, LocationType.EXTRA
    A_SINISTER_TURN_N_SOUTHWEST_PRESERVER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2308, "Southwest Preserver", SC2Mission.A_SINISTER_TURN, LocationType.EXTRA
    A_SINISTER_TURN_N_EAST_PRESERVER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2309, "East Preserver", SC2Mission.A_SINISTER_TURN, LocationType.EXTRA

    ECHOES_OF_THE_FUTURE_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2400, "Victory", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.VICTORY
    ECHOES_OF_THE_FUTURE_N_CLOSE_OBELISK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2401, "Close Obelisk", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.VANILLA
    ECHOES_OF_THE_FUTURE_N_WEST_OBELISK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2402, "West Obelisk", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.VANILLA
    ECHOES_OF_THE_FUTURE_N_BASE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2403, "Base", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.EXTRA
    ECHOES_OF_THE_FUTURE_N_SOUTHWEST_TENDRIL = SC2_NIGHTMARE_LOC_ID_OFFSET + 2404, "Southwest Tendril", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.EXTRA
    ECHOES_OF_THE_FUTURE_N_SOUTHEAST_TENDRIL = SC2_NIGHTMARE_LOC_ID_OFFSET + 2405, "Southeast Tendril", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.EXTRA
    ECHOES_OF_THE_FUTURE_N_NORTHEAST_TENDRIL = SC2_NIGHTMARE_LOC_ID_OFFSET + 2406, "Northeast Tendril", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.EXTRA
    ECHOES_OF_THE_FUTURE_N_NORTHWEST_TENDRIL = SC2_NIGHTMARE_LOC_ID_OFFSET + 2407, "Northwest Tendril", SC2Mission.ECHOES_OF_THE_FUTURE, LocationType.EXTRA

    IN_UTTER_DARKNESS_N_DEFEAT = SC2_NIGHTMARE_LOC_ID_OFFSET + 2500, "Defeat", SC2Mission.IN_UTTER_DARKNESS, LocationType.VICTORY
    IN_UTTER_DARKNESS_N_PROTOSS_ARCHIVE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2501, "Protoss Archive", SC2Mission.IN_UTTER_DARKNESS, LocationType.VANILLA
    IN_UTTER_DARKNESS_N_KILLS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2502, "Kills", SC2Mission.IN_UTTER_DARKNESS, LocationType.VANILLA
    IN_UTTER_DARKNESS_N_URUN = SC2_NIGHTMARE_LOC_ID_OFFSET + 2503, "Urun", SC2Mission.IN_UTTER_DARKNESS, LocationType.EXTRA
    IN_UTTER_DARKNESS_N_MOHANDAR = SC2_NIGHTMARE_LOC_ID_OFFSET + 2504, "Mohandar", SC2Mission.IN_UTTER_DARKNESS, LocationType.EXTRA
    IN_UTTER_DARKNESS_N_SELENDIS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2505, "Selendis", SC2Mission.IN_UTTER_DARKNESS, LocationType.EXTRA
    IN_UTTER_DARKNESS_N_ARTANIS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2506, "Artanis", SC2Mission.IN_UTTER_DARKNESS, LocationType.EXTRA

    GATES_OF_HELL_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2600, "Victory", SC2Mission.GATES_OF_HELL, LocationType.VICTORY
    GATES_OF_HELL_N_LARGE_ARMY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2601, "Large Army", SC2Mission.GATES_OF_HELL, LocationType.VANILLA
    GATES_OF_HELL_N_2_DROP_PODS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2602, "2 Drop Pods", SC2Mission.GATES_OF_HELL, LocationType.VANILLA
    GATES_OF_HELL_N_4_DROP_PODS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2603, "4 Drop Pods", SC2Mission.GATES_OF_HELL, LocationType.VANILLA
    GATES_OF_HELL_N_6_DROP_PODS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2604, "6 Drop Pods", SC2Mission.GATES_OF_HELL, LocationType.EXTRA
    GATES_OF_HELL_N_8_DROP_PODS = SC2_NIGHTMARE_LOC_ID_OFFSET + 2605, "8 Drop Pods", SC2Mission.GATES_OF_HELL, LocationType.CHALLENGE
    GATES_OF_HELL_N_SOUTHWEST_SPORE_CANNON = SC2_NIGHTMARE_LOC_ID_OFFSET + 2606, "Southwest Spore Cannon", SC2Mission.GATES_OF_HELL, LocationType.EXTRA
    GATES_OF_HELL_N_NORTHWEST_SPORE_CANNON = SC2_NIGHTMARE_LOC_ID_OFFSET + 2607, "Northwest Spore Cannon", SC2Mission.GATES_OF_HELL, LocationType.EXTRA
    GATES_OF_HELL_N_NORTHEAST_SPORE_CANNON = SC2_NIGHTMARE_LOC_ID_OFFSET + 2608, "Northeast Spore Cannon", SC2Mission.GATES_OF_HELL, LocationType.EXTRA
    GATES_OF_HELL_N_EAST_SPORE_CANNON = SC2_NIGHTMARE_LOC_ID_OFFSET + 2609, "East Spore Cannon", SC2Mission.GATES_OF_HELL, LocationType.EXTRA
    GATES_OF_HELL_N_SOUTHEAST_SPORE_CANNON = SC2_NIGHTMARE_LOC_ID_OFFSET + 2610, "Southeast Spore Cannon", SC2Mission.GATES_OF_HELL, LocationType.EXTRA
    GATES_OF_HELL_N_EXPANSION_SPORE_CANNON = SC2_NIGHTMARE_LOC_ID_OFFSET + 2611, "Expansion Spore Cannon", SC2Mission.GATES_OF_HELL, LocationType.EXTRA

    BELLY_OF_THE_BEAST_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2700, "Victory", SC2Mission.BELLY_OF_THE_BEAST, LocationType.VICTORY
    BELLY_OF_THE_BEAST_N_FIRST_CHARGE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2701, "First Charge", SC2Mission.BELLY_OF_THE_BEAST, LocationType.EXTRA
    BELLY_OF_THE_BEAST_N_SECOND_CHARGE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2702, "Second Charge", SC2Mission.BELLY_OF_THE_BEAST, LocationType.EXTRA
    BELLY_OF_THE_BEAST_N_THIRD_CHARGE = SC2_NIGHTMARE_LOC_ID_OFFSET + 2703, "Third Charge", SC2Mission.BELLY_OF_THE_BEAST, LocationType.EXTRA
    BELLY_OF_THE_BEAST_N_FIRST_GROUP_RESCUED = SC2_NIGHTMARE_LOC_ID_OFFSET + 2704, "First Group Rescued", SC2Mission.BELLY_OF_THE_BEAST, LocationType.VANILLA
    BELLY_OF_THE_BEAST_N_SECOND_GROUP_RESCUED = SC2_NIGHTMARE_LOC_ID_OFFSET + 2705, "Second Group Rescued", SC2Mission.BELLY_OF_THE_BEAST, LocationType.VANILLA
    BELLY_OF_THE_BEAST_N_THIRD_GROUP_RESCUED = SC2_NIGHTMARE_LOC_ID_OFFSET + 2706, "Third Group Rescued", SC2Mission.BELLY_OF_THE_BEAST, LocationType.VANILLA

    SHATTER_THE_SKY_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2800, "Victory", SC2Mission.SHATTER_THE_SKY, LocationType.VICTORY
    SHATTER_THE_SKY_N_CLOSE_COOLANT_TOWER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2801, "Close Coolant Tower", SC2Mission.SHATTER_THE_SKY, LocationType.VANILLA
    SHATTER_THE_SKY_N_NORTHWEST_COOLANT_TOWER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2802, "Northwest Coolant Tower", SC2Mission.SHATTER_THE_SKY, LocationType.VANILLA
    SHATTER_THE_SKY_N_SOUTHEAST_COOLANT_TOWER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2803, "Southeast Coolant Tower", SC2Mission.SHATTER_THE_SKY, LocationType.VANILLA
    SHATTER_THE_SKY_N_SOUTHWEST_COOLANT_TOWER = SC2_NIGHTMARE_LOC_ID_OFFSET + 2804, "Southwest Coolant Tower", SC2Mission.SHATTER_THE_SKY, LocationType.VANILLA
    SHATTER_THE_SKY_N_LEVIATHAN = SC2_NIGHTMARE_LOC_ID_OFFSET + 2805, "Leviathan", SC2Mission.SHATTER_THE_SKY, LocationType.VANILLA
    SHATTER_THE_SKY_N_EAST_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2806, "East Hatchery", SC2Mission.SHATTER_THE_SKY, LocationType.EXTRA
    SHATTER_THE_SKY_N_NORTH_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2807, "North Hatchery", SC2Mission.SHATTER_THE_SKY, LocationType.EXTRA
    SHATTER_THE_SKY_N_MID_HATCHERY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2808, "Mid Hatchery", SC2Mission.SHATTER_THE_SKY, LocationType.EXTRA

    ALL_IN_N_VICTORY = SC2_NIGHTMARE_LOC_ID_OFFSET + 2900, "Victory", SC2Mission.ALL_IN, LocationType.VICTORY
    ALL_IN_N_FIRST_KERRIGAN_ATTACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2901, "First Kerrigan Attack", SC2Mission.ALL_IN, LocationType.EXTRA
    ALL_IN_N_SECOND_KERRIGAN_ATTACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2902, "Second Kerrigan Attack", SC2Mission.ALL_IN, LocationType.EXTRA
    ALL_IN_N_THIRD_KERRIGAN_ATTACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2903, "Third Kerrigan Attack", SC2Mission.ALL_IN, LocationType.EXTRA
    ALL_IN_N_FOURTH_KERRIGAN_ATTACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2904, "Fourth Kerrigan Attack", SC2Mission.ALL_IN, LocationType.EXTRA
    ALL_IN_N_FIFTH_KERRIGAN_ATTACK = SC2_NIGHTMARE_LOC_ID_OFFSET + 2905, "Fifth Kerrigan Attack", SC2Mission.ALL_IN, LocationType.EXTRA
