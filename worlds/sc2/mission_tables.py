...
class SC2Campaign(Enum):
    ...
    WOLNIGHTMARE = 8 "Wings of Liberty: Nightmare Edition", SC2CampaignGoalPriority.VERY_HARD, SC2Race.TERRAN, "WoLNightmare"
    PROPHECYNIGHTMARE = 9, "Prophecy: Nightmare Edition", SC2CampaignGoalPriority.MINI_CAMPAIGN, SC2Race.PROTOSS, "WoLNightmare"
...
# Wings of Liberty Nightmare
    LIBERATION_DAY_NM = 250, "Liberation Day (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Mar Sara", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_liberation_day", MissionFlag.Terran|MissionFlag.NoBuild|MissionFlag.VsTerran|MissionFlag.HasRaceSwap|MissionFlag.HeroSystemUnsupported
    THE_OUTLAWS_NM = 251, "The Outlaws (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Mar Sara", SC2Race.TERRAN, MissionPools.EASY, "apnightmare_the_outlaws", MissionFlag.Terran|MissionFlag.VsTerran|MissionFlag.HasRaceSwap
    ZERO_HOUR_NM = 252, "Zero Hour (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Mar Sara", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_zero_hour", MissionFlag.Terran|MissionFlag.TimedDefense|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    EVACUATION_NM = 253, "Evacuation (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Colonist", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_evacuation", MissionFlag.Terran|MissionFlag.AutoScroller|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    OUTBREAK_NM = 254, "Outbreak (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Colonist", SC2Race.TERRAN, MissionPools.EASY, "apnightmare_outbreak", MissionFlag.Terran|MissionFlag.Defense|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    SAFE_HAVEN_NM = 255, "Safe Haven (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Colonist", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_safe_haven", MissionFlag.Terran|MissionFlag.Countdown|MissionFlag.VsProtoss|MissionFlag.HasRaceSwap
    HAVENS_FALL_NM = 256, "Haven's Fall (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Colonist", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_havens_fall", MissionFlag.Terran|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    SMASH_AND_GRAB_NM = 257, "Smash and Grab (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Artifact", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_smash_and_grab", MissionFlag.Terran|MissionFlag.Countdown|MissionFlag.VsPZ|MissionFlag.HasRaceSwap
    THE_DIG_NM = 258, "The Dig (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Artifact", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_the_dig", MissionFlag.Terran|MissionFlag.TimedDefense|MissionFlag.VsProtoss|MissionFlag.HasRaceSwap
    THE_MOEBIUS_FACTOR_NM = 259, "The Moebius Factor (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Artifact", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_the_moebius_factor", MissionFlag.Terran|MissionFlag.Countdown|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    SUPERNOVA_NM = 260, "Supernova (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Artifact", SC2Race.TERRAN, MissionPools.HARD, "apnightmare_supernova", MissionFlag.Terran|MissionFlag.Countdown|MissionFlag.VsProtoss|MissionFlag.HasRaceSwap
    MAW_OF_THE_VOID_NM = 261, "Maw of the Void (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Artifact", SC2Race.TERRAN, MissionPools.HARD, "apnightmare_maw_of_the_void", MissionFlag.Terran|MissionFlag.VsProtoss|MissionFlag.HasRaceSwap
    DEVILS_PLAYGROUND_NM = 262, "Devil's Playground (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Covert", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_devils_playground", MissionFlag.Terran|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    WELCOME_TO_THE_JUNGLE_NM = 263, "Welcome to the Jungle (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Covert", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_welcome_to_the_jungle", MissionFlag.Terran|MissionFlag.VsProtoss|MissionFlag.HasRaceSwap
    BREAKOUT_NM = 264, "Breakout (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Covert", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_breakout", MissionFlag.Terran|MissionFlag.NoBuild|MissionFlag.VsTerran|MissionFlag.HasRaceSwap
    GHOST_OF_A_CHANCE_NM = 265, "Ghost of a Chance (Nightmare)", SC2Campaign.WOLNIGHTMARE, "Covert", SC2Race.ANY, MissionPools.STARTER, "apnightmare_ghost_of_a_chance", MissionFlag.Terran|MissionFlag.NoBuild|MissionFlag.VsTerran|MissionFlag.HeroSystemUnsupported
    THE_GREAT_TRAIN_ROBBERY_NM = 266, "The Great Train Robbery (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Rebellion", SC2Race.TERRAN, MissionPools.EASY, "apnightmare_the_great_train_robbery", MissionFlag.Terran|MissionFlag.AutoScroller|MissionFlag.VsTerran|MissionFlag.HasRaceSwap
    CUTTHROAT_NM = 267, "Cutthroat (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Rebellion", SC2Race.TERRAN, MissionPools.EASY, "apnightmare_cutthroat", MissionFlag.Terran|MissionFlag.Countdown|MissionFlag.VsTerran|MissionFlag.HasRaceSwap
    ENGINE_OF_DESTRUCTION_NM = 268, "Engine of Destruction (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Rebellion", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_engine_of_destruction", MissionFlag.Terran|MissionFlag.AutoScroller|MissionFlag.VsTerran|MissionFlag.HasRaceSwap
    MEDIA_BLITZ_NM = 269, "Media Blitz (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Rebellion", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_media_blitz", MissionFlag.Terran|MissionFlag.VsTerran|MissionFlag.HasRaceSwap
    PIERCING_OF_THE_SHROUD_NM = 270, "Piercing the Shroud (Nightmare)", SC2Campaign.WOLNIGHTMARE, "Rebellion", SC2Race.TERRAN, MissionPools.STARTER, "apnightmare_piercing_the_shroud", MissionFlag.Terran|MissionFlag.NoBuild|MissionFlag.VsAll|MissionFlag.HeroSystemUnsupported
    GATES_OF_HELL_NM = 271, "Gates of Hell (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Char", SC2Race.TERRAN, MissionPools.HARD, "apnightmare_gates_of_hell", MissionFlag.Terran|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    BELLY_OF_THE_BEAST_NM = 272, "Belly of the Beast (Nightmare)", SC2Campaign.WOLNIGHTMARE, "Char", SC2Race.ANY, MissionPools.STARTER, "apnightmare_belly_of_the_beast", MissionFlag.Terran|MissionFlag.NoBuild|MissionFlag.VsZerg|MissionFlag.HeroSystemUnsupported
    SHATTER_THE_SKY_NM = 273, "Shatter the Sky (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Char", SC2Race.TERRAN, MissionPools.MEDIUM, "apnightmare_shatter_the_sky", MissionFlag.Terran|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
    ALL_IN_NM = 274, "All-In (Terran, Nightmare)", SC2Campaign.WOLNIGHTMARE, "Char", SC2Race.TERRAN, MissionPools.VERY_HARD, "apnightmare_all_in", MissionFlag.Terran|MissionFlag.TimedDefense|MissionFlag.VsZerg|MissionFlag.HasRaceSwap

    # Prophecy
    WHISPERS_OF_DOOM_NM = 271, "Whispers of Doom (Nightmare)", SC2Campaign.PROPHECYNIGHTMARE, "_1", SC2Race.ANY, MissionPools.STARTER, "apnightmare_whispers_of_doom", MissionFlag.Protoss|MissionFlag.NoBuild|MissionFlag.VsZerg|MissionFlag.HeroSystemUnsupported
    A_SINISTER_TURN_NM = 272, "A Sinister Turn (Protoss, Nightmare)", SC2Campaign.PROPHECYNIGHTMARE, "_2", SC2Race.PROTOSS, MissionPools.MEDIUM, "apnightmare_a_sinister_turn", MissionFlag.Protoss|MissionFlag.VsProtoss|MissionFlag.HasRaceSwap
    ECHOES_OF_THE_FUTURE_NM = 273, "Echoes of the Future (Protoss, Nightmare)", SC2Campaign.PROPHECYNIGHTMARE, "_3", SC2Race.PROTOSS, MissionPools.EASY, "apnightmare_echoes_of_the_future", MissionFlag.Protoss|MissionFlag.VsZerg|MissionFlag.HasRaceSwap|MissionFlag.HeroSystemUnsupported
    IN_UTTER_DARKNESS_NM = 274, "In Utter Darkness (Protoss, Nightmare)", SC2Campaign.PROPHECYNIGHTMARE, "_4", SC2Race.PROTOSS, MissionPools.HARD, "apnightmare_in_utter_darkness", MissionFlag.Protoss|MissionFlag.TimedDefense|MissionFlag.VsZerg|MissionFlag.HasRaceSwap
